...
function CustomersPage() {
  ...
  return (
    <div className="p-6 bg-[#FAF3E0] text-white min-h-[calc(100vh-4rem)] max-w-4xl mx-auto space-y-4 select-none">
          ...
          <div key={c.id} className="flex items-center justify-between p-4 border-b border-[#6F4E37]/10 last:border-0 hover:bg-[#FAF3E0]/20 transition-all duration-200">
            ...
            <div className="flex gap-2">
              <Button 
                ...
                className="hover:bg-[#FAF3E0] text-[#6F4E37]/60 hover:text-white cursor-pointer h-8 w-8 rounded-lg"
              >
